...
public protocol APIManager {
    ...
    var acquiringAccount: AcquiringAccountRoutable { get set }
}
...
public extension API {    
    ...
    mutating func acquiringAccount(route: AcquiringAccountRoute) -> Routeable {
        API.acquiringAccount.route = route
        return API.acquiringAccount
    }
}
