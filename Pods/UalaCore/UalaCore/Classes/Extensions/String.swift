...
public extension String {
    func formatDate(_ mmyy: String, with expectedFormat: String) -> String? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "MM/yy"
        
        // Validate the length of the input received and format it
        guard mmyy.count == 5, let date = dateFormatter.date(from: mmyy) else {
            return nil
        }
        // If the date was successfully unwrapped update the format to return it
        // as it is expected for the request
