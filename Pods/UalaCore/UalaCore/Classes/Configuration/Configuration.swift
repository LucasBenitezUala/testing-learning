...
class Configuration {
    ...
    private func getConfigurationPath(from bundle: StringTables?  = nil) -> String {
        let environment: Environment = ServiceLocator.inject()
    ...
    func getConfigurationConstant<T>(withType _: T.Type, key: ConfigurationConstantsKey, from bundle: StringTables? = nil) -> T? {
    ...
    func getConfigurationConstant<T>(withType _: T.Type, key: ConfigurationConstantsKeyType, from bundle: StringTables? = nil) -> T? {
        guard let constants = self.getConfigurationDict("Constants", from: bundle) else { return nil }
        return constants.object(forKey: key.constantKey) as? T
    }

    private func getConfigurationDict(_ scheme: String = scheme, from bundle: StringTables? = nil) -> NSDictionary? {
        ...
        do {
            ...
            LogManager.shared.debugError(error: error, type: "Plist error")
        }
        return nil
    }
}
...
public extension String {
    static func getConfigurationValue(forKey key: ConfigurationKey, from bundle: StringTables? = nil) -> String {
    ...
    static public func getConfigurationConstant(forKey key: ConfigurationConstantsKeyType, from bundle: StringTables? = nil) -> String {
        return Configuration.shared.getConfigurationConstant(withType: String.self, key: key, from: bundle) ?? ""
    }
}
...
public extension Int {
    ...
    static public func getConfigurationConstant(forKey key: ConfigurationConstantsKeyType, from bundle: StringTables? = nil) -> Int {
        return Configuration.shared.getConfigurationConstant(withType: Int.self, key: key, from: bundle) ?? 0
    }
}
...
public extension Double {
    ...
    static public func getConfigurationConstant(forKey key: ConfigurationConstantsKeyType, from bundle: StringTables? = nil) -> Double {
        return Configuration.shared.getConfigurationConstant(withType: Double.self, key: key, from: bundle) ?? 0.0
    }
}
