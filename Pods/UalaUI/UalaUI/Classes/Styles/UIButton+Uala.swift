...
public struct UalaButtonStyles {
    ...
    public let tagStandard: ButtonStyle = ButtonStyle(
        font: .regular(size: UalaFontBase.captionTwo.adaptativeValue),
        textAlignment: .center,
        textColors: [
            ButtonColor(color: UalaStyle.colors.grey90, state: .normal),
            ButtonColor(color: UalaStyle.colors.grey90.withAlphaComponent(0.3), state: .highlighted),
            ButtonColor(color: .white, state: .selected)
        ],
        backgroundColors: [
            ButtonColor(color: UalaStyle.colors.grey20, state: .normal),
            ButtonColor(color: UalaStyle.colors.grey20.withAlphaComponent(0.3), state: .highlighted),
            ButtonColor(color: UalaStyle.colors.blue40, state: .selected)
        ],
        borderWidth: 0,
        borderColor: .clear,
        corderRadius: 8.0)
