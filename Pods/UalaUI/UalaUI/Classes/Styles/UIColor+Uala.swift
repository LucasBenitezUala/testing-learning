...
public struct UalaColor {
    ...
    public let lightYellow: UIColor   = UIColor(hex: "ffead4")
    public let darkYellow: UIColor    = UIColor(hex: "FD9426")
    ...
    // MARK: - Magenta palette
    public let magenta90: UIColor = UIColor(hex: "9826A8")
    public let magenta80: UIColor = UIColor(hex: "BB4CCA")
    public let magenta70: UIColor = UIColor(hex: "D56AE4")
    public let magenta60: UIColor = UIColor(hex: "F088FF")
    public let magenta50: UIColor = UIColor(hex: "F397FF")
    public let magenta40: UIColor = UIColor(hex: "F5A8FF")
    public let magenta30: UIColor = UIColor(hex: "F7B7FF")
    public let magenta20: UIColor = UIColor(hex: "F9C6FF")
    public let magenta10: UIColor = UIColor(hex: "FBD6FF")
    public let magenta05: UIColor = UIColor(hex: "FDECFF")
    ...
    // MARK: - Fare Text Colors
    public let fareTextMainColor              = UIColor(hex: "3a3a3a")
    public let fareTextSecondaryColor         = UIColor(hex: "565656")
    public let fareTextErrorColor             = UIColor(hex: "d34040")
    public let fareTextSuccessColor           = UIColor(hex: "009464")
    
    // MARK: - Deprecated Colors palette
    public let steel: UIColor                 = UIColor(hex: "8e8e93")
    public let silver: UIColor                = UIColor(hex: "d6d9de")
    public let silverTwo: UIColor             = UIColor(hex: "c7c7cc")
    public let blueGrey: UIColor              = UIColor(hex: "8A93A7")
    public let darkGrey: UIColor              = UIColor(hex: "1a2633")
}
