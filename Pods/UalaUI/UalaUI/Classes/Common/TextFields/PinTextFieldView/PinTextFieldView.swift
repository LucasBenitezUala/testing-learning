...
public class PinTextFieldView: UIView {
    ...
    @IBInspectable
    public var characterLimit: Int = 4 {
        didSet {
    ...
    @IBInspectable
    public dynamic var boxColor: UIColor = .clear {
        didSet {
    ...
    @IBInspectable
    public dynamic var boxBorderColor: UIColor = .clear {
        didSet {
            self.updateTextFieldsUI()
        }
    }
    ...
    public func setActiveTextField() {
