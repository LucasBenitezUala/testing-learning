...
public class ActionFieldView: BaseFieldView, Actionable {
    ...
    @nonobjc public init(_ field: String, _ value: String?, _ color: UIColor? = nil, _ hideBottomLine: Bool = false,
                         highlight: Bool = false, buttonImage: UIImage? = nil, detailAction: DetailViewAction) {
