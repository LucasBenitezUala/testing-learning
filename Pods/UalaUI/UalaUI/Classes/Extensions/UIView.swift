...
public extension UIView {
    ...
    /// Apply all 6 Figma shadow properties to the View
    func applyFigmaShadow(color: UIColor, alpha: Float = 0.5, xOffset: CGFloat = 0.0, yOffset: CGFloat = 0.0, blur: CGFloat, spread: CGFloat = 0) {
        layer.shadowColor = color.cgColor
