...
public extension UIColor {
    ...
    @available(*, deprecated, message: "Use UalaStyle colors instead - UalaStyle.colors.darkGrey")
    ...
    @available(*, deprecated, message: "Use UalaStyle colors instead - UalaStyle.colors.silver")
    static var silver: UIColor {
        return UIColor(hex: "d6d9de")
    }
    
    @available(*, deprecated, message: "Use UalaStyle colors instead - UalaStyle.colors.steel")
    ...
    @available(*, deprecated, message: "Use UalaStyle colors instead - UalaStyle.colors.blueGrey")
    ...
    @available(*, deprecated, message: "Use UalaStyle colors instead - UalaStyle.colors.silverTwo")
