...
open class DetailTransactionViewController: BaseViewController {
    ...
    private func setupHeader() {
        ...
        let fontSizeAmount: CGFloat = 36.0
        let fontSizeAttribute: CGFloat = 25
        amountLabel.font = UIFont.light(size: fontSizeAmount)
        amountLabel.attributedText = header.amount.attributedStringWithColorSize(color: .white, size: fontSizeAttribute)
