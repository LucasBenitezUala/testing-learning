...
public protocol WaitingPresenterProtocol: Presenter {
    @MainActor func handleFeedback(feedbackModel: FeedbackModel)
    @MainActor func handleFeedbackError(error: Error)
    func makeRequest()
