...
public class PopTransferAction: FeedbackViewAction {
    ...
    public init(style: ButtonStyle = UalaStyle.buttons.standardFilledSuccessDark) {
        self.style = style
    }
...
public class InviteUala: FeedbackViewAction {
    ...
    init(style: ButtonStyle = UalaStyle.buttons.standardFilledSuccessDark) {
        self.style = style
    }
...
public class ChargeInfo: FeedbackViewAction {
    ...
    public var style: ButtonStyle = UalaStyle.buttons.standardFilledErrorDark
    public init() { }
