public protocol PathInstruction {
...
public class WavePathGenerator {
    
    public static func firstWave() -> [PathInstruction] {
        return [
    ...
    public static func secondWave() -> [PathInstruction] {
        return [
    ...
    public static func singleWave() -> [PathInstruction] {
        return [
    ...
    public static func loanFirstWave() -> [PathInstruction] {
        return [
            MoveInstruction(point: CGPoint(x: 45.28, y: 0.5)),
            CubicInstruction(point: CGPoint(x: 142.1, y: 9.94), controlPoint1: CGPoint(x: 69.06, y: 0.5), controlPoint2: CGPoint(x: 107.85, y: 9.94)),
            CubicInstruction(point: CGPoint(x: 238.47, y: 4), controlPoint1: CGPoint(x: 176.35, y: 9.94), controlPoint2: CGPoint(x: 210.88, y: 4)),
            CubicInstruction(point: CGPoint(x: 314.91, y: 8.75), controlPoint1: CGPoint(x: 266.06, y: 4), controlPoint2: CGPoint(x: 290.4, y: 8.75)),
            CubicInstruction(point: CGPoint(x: 360, y: 3.63), controlPoint1: CGPoint(x: 339.41, y: 8.75), controlPoint2: CGPoint(x: 346.46, y: 3.63)),
            LineInstruction(point: CGPoint(x: 360, y: 12)),
            LineInstruction(point: CGPoint(x: 0, y: 12)),
            LineInstruction(point: CGPoint(x: 0, y: 3.45)),
            CubicInstruction(point: CGPoint(x: 45.28, y: 0.5), controlPoint1: CGPoint(x: 0, y: 3.45), controlPoint2: CGPoint(x: 21.5, y: 0.5))
        ]
    }

    public static func loanSecondWave() -> [PathInstruction] {
        return [
            MoveInstruction(point: CGPoint(x: 318, y: 0.31)),
            CubicInstruction(point: CGPoint(x: 225.37, y: 11.49), controlPoint1: CGPoint(x: 291.65, y: 0.31), controlPoint2: CGPoint(x: 259.73, y: 11.49)),
            CubicInstruction(point: CGPoint(x: 128.7, y: 0.31), controlPoint1: CGPoint(x: 191.01, y: 11.49), controlPoint2: CGPoint(x: 166.9, y: 0.31)),
            CubicInstruction(point: CGPoint(x: 32.5, y: 13.75), controlPoint1: CGPoint(x: 90.5, y: 0.31), controlPoint2: CGPoint(x: 56.47, y: 13.75)),
            CubicInstruction(point: CGPoint(x: 0.27, y: 10), controlPoint1: CGPoint(x: 8.53, y: 13.75), controlPoint2: CGPoint(x: 0.63, y: 10)),
            CubicInstruction(point: CGPoint(x: 0, y: 16.5), controlPoint1: CGPoint(x: 0.09, y: 10), controlPoint2: CGPoint(x: 0, y: 12.165)),
            LineInstruction(point: CGPoint(x: 360, y: 16.5)),
            LineInstruction(point: CGPoint(x: 360, y: 4.25)),
            CubicInstruction(point: CGPoint(x: 318, y: 0.31), controlPoint1: CGPoint(x: 360, y: 3.96), controlPoint2: CGPoint(x: 344.35, y: 0.31))
        ]
    }
}
