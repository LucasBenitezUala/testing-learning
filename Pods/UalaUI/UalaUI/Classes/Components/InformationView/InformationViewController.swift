...
open class InformationViewController: BaseViewController {
    ...
    open override var presenter: Presenter? {
        return informationViewPresenter
    }
...
extension InformationViewController: InformationViewType {
    ...
    public func updateImage(image: UIImage?) {
        animationContentView.isHidden = true
    ...
    @objc private func backButtonPressed() {
        informationViewPresenter.backButtonPressed()
    }
}
